...
Python was also used to calculate the aggregated mean and median for the differing household incomes. Although the mean and median for Baltimore were lower than Nassau for all income percentiles, supporting the original analysis, the analysis produced slightly different values for some of the mean and median values. For Baltimore, there was a different mean for 50th and 75th by a couple hundred, same for 25th. Similar to earlier, there were some data points that I had not included from the Excel analysis since I had seen empty inputs, but 

In conclusion, Python provided further support for my analysis as I receive the same mean, median, percent calculations, and pivot charts. Therefore, I was able to able provide credibility to my original analysis. For instance, the pivot charts still showed that there are pockets in both locations where household income is lower across all parent income distributions. Additionally, it still found that both the mean and median are higher in Nassau than in Baltimore. No one who grew up in Nassau County, regardless of the income of the parents, were living in poverty in adulthood. According to my data, Baltimore only had very small levels of poverty for those who grew up with parents with incomes higher than the 25th percentile. However, for those with parents' income in the 25th percentile or less, around 60% ended up in poverty when they were adults.
